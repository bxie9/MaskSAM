...
from nnunetv2.sam.sam_model_2024_amos_smallpatch_finallayercnn_tqreshape_patch256 import SAMAdapter_2024_AMOS_SmallPatch_FinalLayerCNN_TQReshape_Patch256
...
class MaskSAM_Synapse(nnUNetTrainer):
    """
    ...
    def build_network_architecture(architecture_class_name: str,
        ...
        network = SAMAdapter_2024_AMOS_SmallPatch_FinalLayerCNN_TQReshape_Patch256(
    ...
    def do_split(self):
        ...
        if self.fold == "all":
            ...
            splits[self.fold]['train']=np.array(['img0006','img0007' ,'img0009', 'img0010', 
                                                'img0021' ,'img0023' ,'img0024','img0026' ,'img0027',
                                                'img0031', 'img0033' ,'img0034','img0039', 'img0040',
                                                'img0005', 'img0028', 'img0030', 'img0037'])
            
            splits[self.fold]['val']=np.array(['img0001', 'img0002', 'img0003', 'img0004', 
                                                'img0008', 'img0022','img0025', 'img0029', 'img0032', 
    ...
    def validation_step(self, batch: dict) -> dict:
        ...
        # batch_instances = self.semseg_insanceseg(target)# mask classification target
